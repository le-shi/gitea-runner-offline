...
ARG RUNNER_IMAGE=gitea/runner:3.1.0
...
LABEL org.opencontainers.image.title="Gitea Runner Offline" \
      org.opencontainers.image.description="Gitea Runner ${RUNNER_VERSION} with Actions, multi-version toolchains, CLIs and dependency caches preloaded" \
      org.opencontainers.image.source="https://github.com/le-shi/gitea-runner-offline" \
      io.gitea.runner.version="${RUNNER_VERSION}" \
